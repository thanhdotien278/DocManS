...
- [ ] Task 5: Verify conflict, TOCTOU, disclosure, and regression behavior (AC: 1-7)
  ...
  - [ ] Test public reason/audit redaction, no hidden candidate existence leak, no delegation/system-role override, and future sources disabled.
